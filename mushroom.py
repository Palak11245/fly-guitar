...
def setting(name, default=""):
    """
    A FLY_* setting, read from the environment.

    The only one that matters here is FLY_STATE_DIR: where learning is kept.
    Point it at a persistent volume on a host that redeploys, or every deploy
    wipes what the fly has learned.
    """
